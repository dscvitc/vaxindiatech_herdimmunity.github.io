...
var classes = [
	{label:"Susceptible",state:"S",label_german:"Nicht Geimpft"},
	{label:"Infected",state:"I",label_german:"Infiziert"},
	{label:"Recovered",state:"R",label_german:"Immun"},
	{label:"Vaccinated",state:"V",label_german:"Geimpft"}
		
]

r0sliderlabel = {english:"Reproduction Number",german:"Ansteckungsgefahr (Basisreproduktionszahl)"}
r0sliderlimit = {english:["low","high"],german:["niedrig","hoch"]}
vsliderlabel = {english:"Vaccination Rate (New Borns)",german:"Impfbereitschaft (Neugeborene) "}
...
var gront = svg.selectAll(".legenditem").data(classes).enter().append("g")
	...
	gront.append("text")
	.attr("transform","translate(15,6)").text(function(d){return lang=="english" ? d.label : d.label_german}).style("opacity",1);	
...
startstopbutton.append("circle").attr("r",buttonheight/2).attr("class","buttonring")
	...
	.attr("transform","translate(0,"+( 5)+")")
		...
		.text("Start").style("text-anchor","middle")
		.style("fill","black")
...
resetbutton.append("circle").attr("r",buttonheight/2).attr("class","buttonring")
	...
	.attr("transform","translate(0,"+( 5)+")")
		.append("text").attr("class","playbuttonlabel")
		.text("Reset").style("text-anchor","middle")
		.style("fill","black")
...
function startsim(){
	...
	d3.select(".playbutton").transition().style("fill","red");
		d3.select(".playbuttonlabel").text("Stop");
